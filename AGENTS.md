...
This file is the quick-reference operating contract for multimap-kotlin. The longer
...
multimap-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`multimap`](https://crates.io/crates/multimap). Upstream Rust is the behavioral oracle while the
